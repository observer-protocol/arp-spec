...
**Generated:** 2026-04-20T22:43:54.587Z  
**Network:** shasta  
**Status:** ❌ FAILED
...
| Role | DID | Address |
|------|-----|---------|
| Sender | did:op:test-sender | `null` |
| Receiver | did:op:test-receiver | `null` |
...
- **check_balances:** SENDER_ADDRESS not set
...
*Run Directory: `/media/nvme/observer-protocol/rails/tron/validation/runs/2026-04-20T22-43-54`*
